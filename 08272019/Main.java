...
public class Main {
	...
	public static void main(String[] args) {
		Album love_supreme = new Album("A Love Supreme", "John Coltrane",
				new GregorianCalendar(1965, Calendar.JANUARY, 12).getTime());
		...
		Album animals = new Album("Animals", "Pink Floyd",
				new GregorianCalendar(1977, Calendar.FEBRUARY, 23).getTime());
